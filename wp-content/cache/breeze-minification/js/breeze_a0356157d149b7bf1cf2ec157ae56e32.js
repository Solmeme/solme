! function(t, e, a) {
    ...
    function pi() {
        setTimeout(function() {
            ...
            if (hi(), _e(), be(), It(), Be(), wt(), fe(), je(), ke(), jn(), ya(), qt(), oa(), Mn(), Yn(), Pe(), ia(), t(".carousel").length > 0 && (Ht(), Ft(), Bt()), t(".owl-carousel").length > 0 && (t(".owl-carousel").each(function() {
                    ...
                    Re()
                }), Ie(), Fe(), Ln(), t(".wpb_row.nectar-split-heading-merged").length > 0 && t(".wpb_row.nectar-split-heading-merged").removeClass("nectar-split-heading-merged"), F.length > 0)
    ...
    function gi(n) {
        ...
        pt.usingMobileBrowser && pt.scrollPosRAF(), sa(),
            ...
            }(), 0 == t('#header-outer[data-remove-fixed="1"]').length && pt.winW > 1e3 && 0 != t(e).scrollTop() && 1 == t('#header-outer.transparent[data-permanent-transparent="false"]').length && d.removeClass("transparent"), pt.winW < 1e3 ? (0 == t(".nectar-box-roll").length || "1" == I && 0 == t('#header-outer[data-remove-fixed="1"]').length) && (wn(), s.on("smartresize.nectarNavScrollEffects", wn)) : (yn(), s.on("smartresize.nectarNavScrollEffects", yn)), ni(), ga(), _e(), i = t("#top #mobile-menu").length > 0 ? "#top #mobile-menu " : ".off-canvas-menu-container.mobile-only ", t(i + ".menu-item > ul > li > a").each(function() {
            ...
            }), Ya(), Ia(), "separate-dropdown-parent-link" == (t("#slide-out-widget-area[data-dropdown-func]").length > 0 ? o.attr("data-dropdown-func") : "default") && t("#slide-out-widget-area .off-canvas-menu-container li.menu-item-has-children").append('<span class="ocm-dropdown-arrow"><i class="fa fa-angle-down"></i></span>'),
            function() {
