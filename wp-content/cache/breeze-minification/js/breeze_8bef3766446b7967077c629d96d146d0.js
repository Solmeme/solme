...
function(t, e) {
    ...
    i.makeArray = function(t) {
        ...
        return t.forEach(function(t) {
            if (t instanceof HTMLElement || 0 != jQuery("body.compose-mode").length)
                if (n) {
                    e(t, n) && s.push(t);
...
function(t, e) {
    ...
    return n.create = function() {
        ...
        var t = this.element.querySelectorAll("a[href], button, input, textarea, select, details,[tabindex]");
        ...
        this.element.classList.add("is-selected"), this.showFocusables(), this.element.removeAttribute("aria-hidden")
    }, n.unselect = function() {
        this.element.classList.remove("is-selected"), this.hideFocusables(), this.element.setAttribute("aria-hidden", "true")
...
function(t, e) {
    ...
    n.extend(p, e.prototype), p._create = function() {
        ...
        if (!this.isActive) {
            ...
            this.$element.hasClass("generate-markup") && (c(t, this.slider), this.viewport.appendChild(this.slider), this.element.appendChild(this.viewport)), this.reloadCells(), this.options.accessibility && (this.element.tabIndex = 0, this.element.addEventListener("keydown", this)), this.emitEvent("activate"), this.selectInitialIndex(), this.isInitActivated = !0, this.dispatchEvent("ready")
        }
        ...
        if (a(this.slider).parent().parent().find(".flickity-page-dots").length > 0) {
            var t = this;
            setTimeout(function() {
                t.pageDots.setDots()
            }, 100)
        ...
        var e = [];
        a(this.slider).find("> *").each(function(t) {
            e[t] = a(this)[0]
        }), this.cells = this._makeCells(e), this.positionCells(), this._getWrapShiftCells(), this.setGallerySize()
    ...
    return p.setCellAlign = function() {
        ...
        if ((!this.nectarOnMobile || 0 != this.nectarOrientationChanged) && this.isActive && !this.isAnimating && !this.isDragging) {
